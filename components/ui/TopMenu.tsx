...
export default function TopMenu({ currentPage = "Home" }: TopMenuProps) {
  ...
  return (
    <div className="relative z-50">
      {/* Top Bar */}
      <div className="flex justify-between items-center px-6 py-4 fade-in">
        <button
          type="button"
      ...
      {menuOpen && (
        <>
          ...
          {/* Menu */}
          <div className="absolute top-full left-4 mt-2 bg-leather-500 rounded-lg shadow-lg border-2 border-leather-400 py-2 min-w-[200px] z-50 menu-dropdown">
            <Link href="/">
              <button
                type="button"
