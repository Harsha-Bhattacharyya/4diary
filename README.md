...
- 🔍 **Powerful Search**: Fuzzy search across all documents with filters (Ctrl/Cmd + K)
...
- 🎯 **Keyboard Shortcuts**: Quick note (Ctrl/Cmd + Q), Vim mode (Ctrl+Shift+V), Calculator (Ctrl+Shift+C), Search (Ctrl/Cmd + K)
